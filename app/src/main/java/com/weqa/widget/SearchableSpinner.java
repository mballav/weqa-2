...
public class SearchableSpinner extends AppCompatSpinner implements View.OnTouchListener,
    ...
    private @ColorInt int _mSearchBackgroundColor;
...
//        _mSearchBackgroundColor = a.getColor(R.styleable.SearchableSpinner_searchBackgroundColor, Color.WHITE);
    ...
    private void init() {
        ...
        if (!TextUtils.isEmpty(_strHintText)) {
            ...
            ArrayAdapter arrayAdapter = new ArrayAdapter(_context, R.layout.spinner_item, _items);
            _isFromInit = true;
            //Log.d("SEARCHABLE-SPINNER", "Adapter-item-count: " + arrayAdapter.getCount());
            setAdapter(arrayAdapter);
        }
    }
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        ...
        if (!_isFromInit) {
            ...
            _isFromInit = false;
            //Log.d("SEARCHABLE-SPINNER", "SETTING THE ADAPTER CORRECTLY! Item Count: " + adapter.getCount());
    ...
    public void setHintText(String hintText) { _strHintText = hintText; }
